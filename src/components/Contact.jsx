  ...
  return (
    <section id="contact">
      <div className="container my-20 mx-auto md:px-6">
        <section className="mb-10 bg-white rounded-xl sm:p-10 p-5 shadow-2xl shadow-black/10 dark:shadow-black/50">
          <div className="flex flex-wrap">
            <div className="mb-5 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:px-6">
              <h2 className="mb-6 text-3xl font-bold text-primary dark:text-primary-400">
                Contact us
              </h2>
            ...
            <div className="mb-2 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:px-6">
              <form>
                <div className="relative mb-6" data-te-input-wrapper-init>
                  <input
                    type="text"
                    className="bg-neutral-100  peer block min-h-[auto] w-full rounded border-0 bg-transparent py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                    id="exampleInput90"
                    placeholder="Name"
                  />
                  <label
