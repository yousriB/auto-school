    ...
    <section id="team">
      <div className="container my-24 mx-auto md:px-6">
        <section className="mb-32 text-center">
          <h2 className="mb-12 text-3xl font-bold text-primary dark:text-primary-400">
            Meet the team
          </h2>

          <div className="grid gap-x-6 md:grid-cols-4 lg:gap-x-12">
            <div className="mb-6 lg:mb-0">
              <div className="block rounded-lg bg-white shadow-xl shadow-black/12 dark:shadow-black/50 dark:bg-neutral-700">
